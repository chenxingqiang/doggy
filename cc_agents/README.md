...
<div align="center">
  <p>
    <strong>Pre-built AI agents for doggy powered by Claude Code</strong>
  </p>
  <p>
...
1. In doggy, navigate to **CC Agents**
...
1. Download a `.doggy.json` file from this repository
2. In doggy, navigate to **CC Agents**
3. Click the **Import** dropdown button
4. Select **From File**
5. Choose the downloaded `.doggy.json` file
...
4. Choose where to save the `.doggy.json` file

### Agent File Format

All agents are stored in `.doggy.json` format with the following structure:
...
### 1. Create Your Agent
Design and test your agent in doggy with a clear, focused purpose.

### 2. Export Your Agent
Export your agent to a `.doggy.json` file with a descriptive name.

### 3. Submit a Pull Request
1. Fork this repository
2. Add your `.doggy.json` file to the `cc_agents` directory
...
These agents are provided under the same license as the doggy project. See the main LICENSE file for details.

---

<div align="center">
  <strong>Built with ❤️ by the doggy community</strong>
</div> 
